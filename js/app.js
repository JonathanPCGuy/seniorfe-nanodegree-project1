...
// ok how to do this with knockout or backbone or whatever

// this whole project is ugly. need to shake off a lot of rust

var submitButton = $('#submit');
// not sure how to hold these values; tbd
var locationField = $('#location-field')[0];

submitButton.click(function() {
    // reset fields
    locationField.setCustomValidity('');
    var testtest = locationField.value;
    if(locationField.value.length == 0) {
        locationField.setCustomValidity('Please specify a location');
    }
});
